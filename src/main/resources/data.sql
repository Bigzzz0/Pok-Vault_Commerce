...
((SELECT id FROM card_expansions WHERE code = 'A1'), '036/226', 'Charizard ex', 'POKEMON', 'IMMERSIVE_RARE', 'FIRE', 180, 2, 'https://assets.pokemon-zone.com/cards/a1/036.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Mewtwo ex (Immersive)
((SELECT id FROM card_expansions WHERE code = 'A1'), '129/226', 'Mewtwo ex', 'POKEMON', 'IMMERSIVE_RARE', 'PSYCHIC', 150, 2, 'https://assets.pokemon-zone.com/cards/a1/129.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Pikachu ex (Immersive)
((SELECT id FROM card_expansions WHERE code = 'A1'), '095/226', 'Pikachu ex', 'POKEMON', 'IMMERSIVE_RARE', 'LIGHTNING', 120, 1, 'https://assets.pokemon-zone.com/cards/a1/095.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Articuno ex
...
-- Zapdos ex
((SELECT id FROM card_expansions WHERE code = 'A1'), '104/226', 'Zapdos ex', 'POKEMON', 'DOUBLE_RARE', 'LIGHTNING', 130, 1, 'https://assets.pokemon-zone.com/cards/a1/104.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Moltres ex
...
-- Venusaur ex
((SELECT id FROM card_expansions WHERE code = 'A1'), '004/226', 'Venusaur ex', 'POKEMON', 'DOUBLE_RARE', 'GRASS', 190, 3, 'https://assets.pokemon-zone.com/cards/a1/004.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
-- Blastoise ex
...
-- Sabrina Supporter
((SELECT id FROM card_expansions WHERE code = 'A1'), '225/226', 'Sabrina', 'TRAINER_SUPPORTER', 'SUPER_RARE', NULL, NULL, NULL, 'https://assets.pokemon-zone.com/cards/a1/225.png', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
